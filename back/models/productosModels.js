...
const productosSchema=mongoose.Schema({
    nombre:{
        ...
        trim:true,
        maxLength:[120,"El nombre del producto excede el limite maximo de caracteres."],
    ...
    descripcion:{
        ...
        trim:true,
        maxLength:[1000,"El descripcion del producto excede el limite maximo de caracteres."],
