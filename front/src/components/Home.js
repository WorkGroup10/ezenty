              ...
              {productos && productos.map (producto => (
                  <div key={producto._id} className="col-sm-12 col-md-6 col-lg-3 my-3">
                    ...
                    <div className="card-body d-flex flex-column">
                      <h5 className="card-text text-center" id="titulo_producto">
                        <Link to={`productos/${producto._id}`}>{producto.nombre}</Link>
                      </h5>
                      <p className="card-text text-center" id="precio_producto">
                        ${producto.precio}
                      </p>
                      <button type="button" className="btn" id="añadir" disabled={producto.stock===0}>
                        <img
                            className="card-image-top mt-auto align-center"
                            width="50"
                            src="../images/car.png"
